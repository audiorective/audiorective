...
2. **6 channels (user-asset driven):** Drums, Bass, Synth 1, Synth 2, Vox = StreamPlayer stems; FX = SoundPlayer (8 one-shot pads, click + keys 1–8). _(Earlier iterations used a generated synth-bass; the user's real Bass + Vox stems superseded it, and the synth source was removed.)_
